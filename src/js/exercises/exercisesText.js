//Math.random() -> [0, 1] inclusi i decimali
//Math.floor(Math.random()) -> 0, 1
//Math.flor(Math.random() * 201) -> [0, 200] solo gli interi
//Math.floor(Math.random() * 201) - 100) -> crea l'intervallo [0, 200] e lo sposta nell'intervallo [-100, 100]

//1. Creare un array di 25 numeri casuali tra -100 e 100, e copiarlo in un secondo array, duplicando gli elementi in posizione pari e dimezzando quelli in posizione dispari; (stampare gli array)
